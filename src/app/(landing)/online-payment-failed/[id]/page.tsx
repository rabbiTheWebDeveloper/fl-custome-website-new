import { XCircle, AlertTriangle, HelpCircle, ArrowLeft } from "lucide-react"
...
export default function PaymentFailedRedesigned({
  ...
  const { id } = use(params)
  // Generate a deterministic transaction reference from the ID
  const transactionRef = `TXN_${id.slice(-8).toUpperCase()}`
