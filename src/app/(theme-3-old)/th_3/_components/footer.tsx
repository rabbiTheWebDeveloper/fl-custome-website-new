      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div className="md:col-span-2 space-y-6">
            {/* Address */}
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow border flex items-start gap-4 hover:shadow-xl transition-colors duration-300">
        ...
        {/* Divider */}
        <div className="h-px bg-gradient-to-r from-transparent via-gray-300 dark:via-gray-700 to-transparent my-10 transition-colors duration-500" />
