        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              {/* Contact Info */}
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 dark:bg-gray-800 dark:border dark:border-gray-700">
                ...
                <div className="grid md:grid-cols-1 gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full border border-gray-300 dark:border-gray-600 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm sm:text-base dark:bg-gray-700 dark:text-gray-100"
                ...
                <div className="grid md:grid-cols-1 gap-3 sm:gap-4 mb-6">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="tel"
                        className="w-full border border-gray-300 dark:border-gray-600 rounded-lg sm:rounded-xl pl-10 sm:pl-12 pr-3 sm:pr-4 py-2 sm:py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm sm:text-base dark:bg-gray-700 dark:text-gray-100"
                ...
                <div className="grid md:grid-cols-1 gap-3 sm:gap-4 mb-6">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        rows={3}
                        className="w-full border border-gray-300 dark:border-gray-600 rounded-lg sm:rounded-xl pl-10 sm:pl-12 pr-3 sm:pr-4 py-2 sm:py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm sm:text-base resize-none dark:bg-gray-700 dark:text-gray-100"
                ...
                <div className="grid md:grid-cols-1 gap-3 sm:gap-4 mb-6">
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full border border-gray-300 dark:border-gray-600 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm sm:text-base resize-none dark:bg-gray-700 dark:text-gray-100"
                      {...register("orderNote")}
                    />
                  </div>
                </div>
              ...
              {/* Payment Method */}
              <div className="space-y-6 bg-white rounded-2xl pb-5 dark:bg-gray-800 dark:border dark:border-gray-700">
                <h3 className="text-lg md:text-xl font-bold mb-4 p-5 border-b dark:border-gray-700">
                  Payment Method
                </h3>
                <div className="px-5">
                  <RadioGroup
                    ...
                    {paymentMethods.map((method) => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs sm:text-sm opacity-80">{method.description}</p>
                        </div>
                        {method.image && (
                          <Image src={method.image} alt={method.name} width={80} height={24} />
                        )}
                      </label>
                    ))}
                  </RadioGroup>
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 sticky top-4 sm:top-6 dark:bg-gray-800 dark:border dark:border-gray-700">
                ...
                <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6 max-h-64 sm:max-h-80 overflow-y-auto pr-2">
                  {items.map((item) => (
                    <div key={item.id} className="flex items-start gap-3 sm:gap-4 pb-3 sm:pb-4 border-b border-gray-100 dark:border-gray-700">
                      <div className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-700 flex-shrink-0 border border-gray-200 dark:border-gray-600">
                        <Image
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start mb-2">
                          <div className="min-w-0 pr-2">
                            <h4 className="font-medium text-gray-900 dark:text-gray-100 text-sm sm:text-base line-clamp-2 leading-tight">{item.name}</h4>
                          </div>
                          <button
                            onClick={() => handleRemoveProduct(item.id)}
                            className="text-gray-400 dark:text-gray-300 hover:text-red-500 transition-colors flex-shrink-0 ml-1 p-0.5 rounded-full hover:bg-red-50"
                          >
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg">
                            <button
                              ...
                              className="px-2.5 py-1.5 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                              disabled={item.quantity <= 1}
                            >
                              -
                            </button>
                            <span className="px-3 py-1.5 font-medium text-sm text-gray-900 dark:text-gray-100 min-w-[2rem] text-center">{item.quantity}</span>
                            <button
                              onClick={() => handleQuantityChange(item.id, item.quantity + 1)}
                              className="px-2.5 py-1.5 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                              disabled={item.quantity >= (item.metadata?.maxQuantity ?? 10)}
                            >
                              +
                            </button>
                          </div>
                ...
                <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-700 pt-3 sm:pt-4 flex justify-between font-bold text-gray-900 dark:text-gray-100 text-base sm:text-lg">
                    <span>Total</span>
                ...
                >
                  {isSubmitting ? (
                    ...
                    <div className="flex w-full items-center gap-3">
                      ...
                      <span>{items.length === 0 ? "Your cart is empty" : "Place Order"}</span>
                    </div>
                  )}
                </button>
              </div>
