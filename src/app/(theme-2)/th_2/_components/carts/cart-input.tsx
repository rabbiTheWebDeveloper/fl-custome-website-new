...
interface CartInputProps {
  ...
  inputOnly?: boolean
  /** Callback with immediate input value changes */
...
export const CartInput = ({
  ...
  return (
    <div className={cn("flex flex-col gap-2", className?.root)}>
      ...
      <div className="flex items-center focus-within:ring-2 ring-ring transition-shadow ring-0 ring-offset-0 focus-within:ring-offset-3 ring-offset-background rounded-xl border border-muted">
        <Button
          type="button"
          variant="secondary"
          size="icon"
        ...
        <div className="relative w-full text-center">
          <Input
            ...
            value={localValue}
            className={cn(
              "max-w-24 w-12 text-center shadow-none border-transparent min-w-0 pr-0 pl-0 rounded-none h-13 bg-transparent!",
