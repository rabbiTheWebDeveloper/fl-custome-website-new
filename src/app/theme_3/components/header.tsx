...
export default function Header() {
  ...
  return (
    <>
      {/* ================= PROMO BAR ================= */}
      <div className="bg-gradient-to-r from-green-600 to-emerald-500 text-white text-sm">
            ...
            <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
              ...
              <div className="relative dropdown">
                <button
                  ...
                  className="flex items-center gap-3 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-colors"
                >
