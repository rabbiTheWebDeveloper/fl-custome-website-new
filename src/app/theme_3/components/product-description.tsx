...
const ProductDescription = () => {
  ...
  const sampleProduct = {
    ...
    long_description: "<p>This is a detailed long description of the product.</p>",
    ...
    <section className="max-w-7xl mx-auto px-4 py-10">
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <h4 className={sampleProduct.product_qty < 1 ? "text-red-500 font-bold flex items-center gap-1" : "text-green-600 font-bold flex items-center gap-1"}>
            {sampleProduct.product_qty > 0 ? <><CheckCircle size={18} /> In Stock</> : <><XCircle size={18} /> Out of Stock</>}
          </h4>
          ...
          <h3 className="text-xl font-semibold">
            ...
            {sampleProduct.price > sampleProduct.discounted_price && (
              <span className="line-through text-gray-500 ml-2">৳ {sampleProduct.price}</span>
            )}
          </h3>
          ...
          <div
            ...
            dangerouslySetInnerHTML={{ __html: sampleProduct.short_description }}
          />
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {relatedProducts.map((product) => (
            <Link key={product?.id} href={`/details/${product.slug}?id=${product.id}`}>
              <div className="bg-white rounded-xl shadow-md p-4 hover:shadow-lg transition flex flex-col">
                ...
                <h5 className="text-sm font-medium mb-2 line-clamp-2">{product.product_name}</h5>
